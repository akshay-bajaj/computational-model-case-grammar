...
class namesAndObjects:
    list_of_names = ["Aaradhya", "Adah", "Adhira", "Alisha", "Amoli", "Anaisha", "Ananya", "Anika", "Anushka", "Asmee",
                 ...
                 "Shanaya", "Shrishti","Sneha", "Taahira", "Taara", "Tanvi", "Viti", "Zara", "Aahva", "Aadiv", "Aarav",
                 ...
                 "Naksh", "Nimit", "Nirav", "Pahal", "Parv", "Pranay", "Rachit", "Raj", "Ranbir", "Raunak", "Reyansh",
    ...
    list_of_objects = ["Pen", "Diary", "Bottle", "Glasses", "Watch", "Camera", "Brush", "Credit Card", "Key",
    ...
    def random_object_generator(self, n):
        names_generated = random.sample(self.list_of_objects, n)
        return names_generated
